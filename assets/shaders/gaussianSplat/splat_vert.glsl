...
void main(void)
{
    ...
    float WZ =  projMat[3][2]; // first index is column, second is row
    float tzSq = t.z * t.z;
    ...
    //https://github.com/graphdeco-inria/diff-gaussian-rasterization/issues/14?u=http://github.com/interestingLSY/diff-gaussian-rasterization/commit/989320fdf2563dc06bef852dc78ebd2cf820c5ba
    // To make a gaussian 1 pixel width,
    // the 1sigma could be half pixel.
    //So the covariance was added by 0.3 (≈0.548^2).
    cov2D[0][0] += 0.3f;
    cov2D[1][1] += 0.3f;
